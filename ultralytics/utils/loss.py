...
from .metrics import bbox_iou, probiou, bbox_inner_iou,bbox_focaler_iou,  bbox_focaler_mpdiou, WiseIouLoss
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask,
        ...
        if self.use_wiseiou:
            ...
            # iou = bbox_inner_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, PIoU=True, ratio=0.7)
